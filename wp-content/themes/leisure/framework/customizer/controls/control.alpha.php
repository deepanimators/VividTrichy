 ...
 */
class Leisure_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function render_content() {
      ...
      <?php echo esc_html( $this->label ); ?>
        ...
        <input class="color-picker" type="text" data-show-opacity="<?php echo $show_opacity; ?>"
               data-palette="<?php echo esc_attr( $palette ); ?>" data-alpha-enabled="true"
